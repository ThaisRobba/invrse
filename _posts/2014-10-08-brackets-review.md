...
<video src="{{site.baseurl}}/assets/brackets_colors.webm" autoplay="autoplay" loop width="100%" max-height="280">Your browser does not support the <code>video</code> element :(</video>
