...
###1. Autocomplete Plus
![Completion like a boss]({{site.baseurl}}/assets/atom_completion.png)
...
###2. Git Plus
![Imma gonna git ya!]({{site.baseurl}}/assets/atom_git_plus.png)
...
###3. Git History
![Gonna git ya good!]({{site.baseurl}}/assets/atom_git_history.png)
...
###4. Git Blame
![Git!]({{site.baseurl}}/assets/atom_git_blame.png)
...
###5. Open Last Project
![Hello old friends]({{site.baseurl}}/assets/atom_open_last.png)
...
###6. Color Picker
![Picking colors is easy]({{site.baseurl}}/assets/atom_color_picker.png)
...
###7. JSHint
![Sorry, commagain?]({{site.baseurl}}/assets/atom_jshint.png)
...
###8. JSFormat
![Bam!]({{site.baseurl}}/assets/atom_jsformat.gif)
