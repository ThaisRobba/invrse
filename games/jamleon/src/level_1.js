var level_1 = {
	...
	playerCreate: function() {
		...
		this.player.animations.add('yellow_walk', [9, 10], 8);
		...
		this.player.animations.add('red_walk', [15, 16], 8);
		...
		this.player.animations.add('purple_walk', [21, 22], 8);
